...
import {categoryUrlBuilder, productUrlBuilder} from '@salesforce/retail-react-app/app/utils/url'
...
import {getImageUrl} from 'amplience-api-react'
...
export const useShoppableTooltip = (target, selector, tooltips) => {
    ...
    switch (selector) {
        case 'product':
            ...
            break
        case 'category': {
            defaultTooltip = ampContext.client.categories[target].name ?? target
            break
        }
        case 'contentKey':
            defaultTooltip = intl.formatMessage({
